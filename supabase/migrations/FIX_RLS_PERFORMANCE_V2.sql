-- =====================================================
-- SCRIPT PARA OTIMIZAR PERFORMANCE DAS POLÍTICAS RLS (V2)
-- Executar no SQL Editor do Supabase
-- Data: 2025-12-03
-- =====================================================

-- NOTA: Algumas tabelas podem não ter coluna user_id
-- Este script ignora erros de tabelas/políticas inexistentes
...
-- =====================================================
-- PASSO 15: SALES_PROFESSIONALS (tem user_id direto)
-- =====================================================
...
DROP POLICY IF EXISTS "Users can view their own sales_professionals" ON public.sales_professionals;
DROP POLICY IF EXISTS "Users can insert their own sales_professionals" ON public.sales_professionals;
DROP POLICY IF EXISTS "Users can update their own sales_professionals" ON public.sales_professionals;
DROP POLICY IF EXISTS "Users can delete their own sales_professionals" ON public.sales_professionals;
...
DROP POLICY IF EXISTS "Users can view their own evolution_settings" ON public.evolution_settings;
DROP POLICY IF EXISTS "Users can insert their own evolution_settings" ON public.evolution_settings;
DROP POLICY IF EXISTS "Users can update their own evolution_settings" ON public.evolution_settings;
DROP POLICY IF EXISTS "Users can delete their own evolution_settings" ON public.evolution_settings;
...
-- =====================================================
-- PASSO 20: PATIENT_REMINDER_SETTINGS
-- =====================================================
...
-- =====================================================
-- PASSO 21: DISCOUNT_COUPONS (Admin policies)
-- =====================================================
...
-- =====================================================
-- PASSO 22: USER_SUBSCRIPTIONS (Admin + own)
-- =====================================================
