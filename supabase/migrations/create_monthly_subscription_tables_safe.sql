-- =====================================================
-- CREATE MONTHLY SUBSCRIPTION TABLES (SAFE MODE)
-- =====================================================
...
-- =====================================================
-- LIMPAR POLÍTICAS E TABELAS EXISTENTES
-- =====================================================

-- Remover tabelas antigas (CASCADE remove policies automaticamente)
-- A ordem importa: remover primeiro as que têm foreign keys
DROP TABLE IF EXISTS subscription_payments CASCADE;
DROP TABLE IF EXISTS patient_subscriptions CASCADE;
DROP TABLE IF EXISTS user_monthly_plans CASCADE;

-- Remover função de trigger se existir
DROP FUNCTION IF EXISTS update_monthly_plans_updated_at() CASCADE;

-- =====================================================
-- TABELA DE PLANOS DE MENSALIDADE DO USUÁRIO
-- =====================================================

CREATE TABLE user_monthly_plans (
...
DO $$
BEGIN
  RAISE NOTICE '✅ Tabelas de mensalidade criadas com sucesso!';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '  - Policies criadas para isolamento por user_id';
  RAISE NOTICE '';
  RAISE NOTICE '🎯 PRÓXIMO PASSO:';
  RAISE NOTICE '  - Acesse /app/mensalidades no site';
  RAISE NOTICE '  - Crie novos planos (ex: Clube do Botox)';
  RAISE NOTICE '  - Os dados agora serão salvos permanentemente!';
END $$;
