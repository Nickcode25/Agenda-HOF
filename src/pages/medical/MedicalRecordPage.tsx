        ...
        {activeTab === 'anamnesis' && (
          <div>
            <div className="space-y-6">
              {/* Informações Clínicas e Observações */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pb-6 border-b border-gray-700">
                <div className="bg-gray-700/50 border border-gray-600 rounded-xl p-5">
                  <h3 className="text-sm font-semibold text-orange-400 mb-2 flex items-center gap-2">
                    <FileText size={16} />
                    Informações Clínicas
                  </h3>
                  <p className="text-white whitespace-pre-wrap">{patient.clinicalInfo || 'Nenhuma informação clínica registrada'}</p>
                </div>
                ...
                <div className="bg-gray-700/50 border border-gray-600 rounded-xl p-5">
                  ...
                  <p className="text-white whitespace-pre-wrap">{patient.notes || 'Nenhuma observação'}</p>
                </div>
              </div>
