    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">Gerencie cupons para o checkout</p>
        </div>
        <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="PROMO50"
                  maxLength={50}
                  className="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-white uppercase"
                  required
                />
              </div>
                  ...
                  <tr key={coupon.id} className="hover:bg-gray-700/30 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-green-400 font-semibold">{coupon.discount_percentage}%</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
