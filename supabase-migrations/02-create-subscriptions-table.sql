...
-- Execute DEPOIS do 01-create-coupons-table.sql
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_user_subscriptions_pagbank_id ON user_subscriptions(pagbank_subscription_id);
CREATE INDEX IF NOT EXISTS idx_subscription_payments_subscription_id ON subscription_payments(subscription_id);
CREATE INDEX IF NOT EXISTS idx_subscription_payments_status ON subscription_payments(status);
CREATE INDEX IF NOT EXISTS idx_pagbank_webhooks_processed ON pagbank_webhooks(processed);
CREATE INDEX IF NOT EXISTS idx_pagbank_webhooks_event_type ON pagbank_webhooks(event_type);
...
-- Webhooks: Service role pode fazer tudo
CREATE POLICY "Service role can manage webhooks" ON pagbank_webhooks
  FOR ALL
  TO service_role
  USING (TRUE)
  WITH CHECK (TRUE);
...
DO $$
BEGIN
  RAISE NOTICE '✅ Tabela de assinaturas criada com sucesso!';
END $$;
